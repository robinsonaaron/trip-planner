                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: flightInstance, field: 'airline', 'errors')}">
                                    <g:select name="airline.id" from="${trip.planner.Airline.list()}" optionKey="id" value="${flightInstance?.airline?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: flightInstance, field: 'departureAirport', 'errors')}">
                                    <g:select name="departureAirport.id" from="${trip.planner.Airport.list()}" optionKey="id" value="${flightInstance?.departureAirport?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: flightInstance, field: 'arrivalAirport', 'errors')}">
                                    <g:select name="arrivalAirport.id" from="${trip.planner.Airport.list()}" optionKey="id" value="${flightInstance?.arrivalAirport?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: flightInstance, field: 'trip', 'errors')}">
                                    <g:select name="trip.id" from="${trip.planner.Trip.list()}" optionKey="id" value="${flightInstance?.trip?.id}"  />
                                </td>
                            </tr>
